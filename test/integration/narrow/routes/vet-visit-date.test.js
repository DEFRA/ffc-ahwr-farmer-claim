...
describe('Vet, enter date of visit', () => {
  ...
  describe(`POST to ${url} route`, () => {
    ...
    test.each([
      ...
      { description: 'missing onAnotherDay', day: today.getDate(), month: today.getMonth() + 1, year: today.getFullYear(), whenCarriedOut: 'onAnotherDate', errorMessage: 'Enter a date in the correct format', errorHighlights: ['on-another-date-day', 'on-another-date-month', 'on-another-date-year'], applicationCreationDate: today },
      { description: 'missing onAnotherDay - missing day and month', day: today.getDate(), month: today.getMonth() + 1, year: today.getFullYear(), whenCarriedOut: 'onAnotherDate', onAnotherDateDay: '', onAnotherDateMonth: '', onAnotherDateYear: 2023, errorMessage: 'Enter a date in the correct format', errorHighlights: ['on-another-date-day', 'on-another-date-month'], applicationCreationDate: today },
      ...
      { description: 'missing onAnotherDay - missing year', day: today.getDate(), month: today.getMonth() + 1, year: today.getFullYear(), whenCarriedOut: 'onAnotherDate', onAnotherDateDay: 10, onAnotherDateMonth: 10, errorMessage: 'Enter a date in the correct format', errorHighlights: ['on-another-date-year'], applicationCreationDate: today }
