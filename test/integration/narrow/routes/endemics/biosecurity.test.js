...
describe('Biosecurity test when Optional PI Hunt is OFF', () => {
  ...
  describe(`GET ${url} route`, () => {
    ...
    test('Returns 200', async () => {
      ...
      getEndemicsClaim.mockReturnValue({ typeOfLivestock: 'pigs', reference: '12345' })
    ...
    test('Returns 200 when the review test result for beef is negative', async () => {
      ...
      getEndemicsClaim.mockReturnValue({ typeOfLivestock: 'beef', reviewTestResults: 'negative', reference: '12345' })
    ...
    test("select 'yes' when biosecurity is 'yes'", async () => {
      ...
      getEndemicsClaim.mockReturnValue({ typeOfLivestock: 'pigs', biosecurity: 'yes', reference: '12345' })
...
describe('Biosecurity test when Optional PI Hunt is ON', () => {
  ...
  describe(`GET ${url} route`, () => {
    test.each([
      ...
      getEndemicsClaim.mockReturnValue({ typeOfLivestock, piHunt, piHuntRecommended, reviewTestResults, piHuntAllAnimals, reference: '12345' })
      const options = {
        method: 'GET',
        url,
        auth
